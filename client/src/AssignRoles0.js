...
function AssignRoles() {
    ...
    return (
        <div>
            ...
            <br />
            <span><b>Connected Wallet: </b> {currentaccount}</span>
            <br />
            <br />
            ...
            <form onSubmit={handlerSubmitPROD}>
                ...
                <button className="btn btn-outline-success btn-sm" onSubmit={handlerSubmitPROD}>Register</button>
            </form>
            ...
            <form onSubmit={handlerSubmitPROC}>
                ...
                <button className="btn btn-outline-success btn-sm" onSubmit={handlerSubmitPROC}>Register</button>
            </form>
            <table className="table table-sm">
                <thead>
                    <tr>
            ...
            <form onSubmit={handlerSubmitMAY}>
                <input className="form-control-sm" type="text" onChange={handlerChangeAddressMAY} placeholder="Assigned Wallet" required />
                <input className="form-control-sm" type="text" onChange={handlerChangeNameMAY} placeholder="Wholesaler" required />
                <input className="form-control-sm" type="text" onChange={handlerChangePlaceMAY} placeholder="Location" required />
                <button className="btn btn-outline-success btn-sm" onSubmit={handlerSubmitMAY}>Register</button>
            </form>
            <table className="table table-sm">
                <thead>
                    <tr>
